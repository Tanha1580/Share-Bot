...
def fsub_button(client, message):
    ...
    if FORCE_SUB_CHANNEL_1 and not FORCE_SUB_CHANNEL_2 and not FORCE_SUB_CHANNEL_3 and not FORCE_SUB_CHANNEL_REQUEST_1 and FORCE_SUB_CHANNEL_REQUEST_2 and not FORCE_SUB_CHANNEL_REQUEST_3:
        ...
        try:
            ...
            pass
        return buttons
    if not FORCE_SUB_CHANNEL_1 and FORCE_SUB_CHANNEL_2 and not FORCE_SUB_CHANNEL_3 and FORCE_SUB_CHANNEL_REQUEST_1 and not FORCE_SUB_CHANNEL_REQUEST_2 and not FORCE_SUB_CHANNEL_REQUEST_3:
        buttons = [
            [
                InlineKeyboardButton(text = "• عضویت اول", url = client.reinvitelink1)
            ],
    ...
    if FORCE_SUB_CHANNEL_1 and FORCE_SUB_CHANNEL_2 and not FORCE_SUB_CHANNEL_3 and not FORCE_SUB_CHANNEL_REQUEST_1 and not FORCE_SUB_CHANNEL_REQUEST_2 and FORCE_SUB_CHANNEL_REQUEST_3:
        ...
        try:
            ...
            pass
        return buttons
    if not FORCE_SUB_CHANNEL_1 and not FORCE_SUB_CHANNEL_2 and FORCE_SUB_CHANNEL_3 and FORCE_SUB_CHANNEL_REQUEST_1 and FORCE_SUB_CHANNEL_REQUEST_2 and not FORCE_SUB_CHANNEL_REQUEST_3:
        buttons = [
            [
                InlineKeyboardButton(text = "• عضویت اول", url = client.reinvitelink1)
            ],
        ...
        try:
            ...
            pass
        return buttons
    if not FORCE_SUB_CHANNEL_1 and FORCE_SUB_CHANNEL_2 and not FORCE_SUB_CHANNEL_3 and not FORCE_SUB_CHANNEL_REQUEST_1 and not FORCE_SUB_CHANNEL_REQUEST_2 and FORCE_SUB_CHANNEL_REQUEST_3:
        buttons = [
            [
                InlineKeyboardButton(text = "• عضویت اول", url = client.reinvitelink1)
            ],
        ...
        try:
            ...
            pass
        return buttons
    if FORCE_SUB_CHANNEL_1 and not FORCE_SUB_CHANNEL_2 and FORCE_SUB_CHANNEL_3 and not FORCE_SUB_CHANNEL_REQUEST_1 and not FORCE_SUB_CHANNEL_REQUEST_2 and not FORCE_SUB_CHANNEL_REQUEST_3:
        buttons = [
            [
                InlineKeyboardButton(text = "• عضویت اول", url = client.invitelink1)
            ],
        ...
        try:
            ...
            pass
        return buttons
    if not FORCE_SUB_CHANNEL_1 and FORCE_SUB_CHANNEL_2 and FORCE_SUB_CHANNEL_3 and FORCE_SUB_CHANNEL_REQUEST_1 and not FORCE_SUB_CHANNEL_REQUEST_2 and not FORCE_SUB_CHANNEL_REQUEST_3:
        buttons = [
            [
                InlineKeyboardButton(text = "• عضویت اول", url = client.reinvitelink1)
            ],
