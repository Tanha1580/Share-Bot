...
def fsub_button(client, message):
    ...
    if not FORCE_SUB_CHANNEL_1 and not FORCE_SUB_CHANNEL_2 and not FORCE_SUB_CHANNEL_3 and not FORCE_SUB_CHANNEL_4 and FORCE_SUB_CHANNEL_REQUEST_1 and FORCE_SUB_CHANNEL_REQUEST_2 and not FORCE_SUB_CHANNEL_REQUEST_3 and not FORCE_SUB_CHANNEL_REQUEST_4:
        ...
        try:
            ...
            pass
        return buttons
    if not FORCE_SUB_CHANNEL_1 and not FORCE_SUB_CHANNEL_2 and not FORCE_SUB_CHANNEL_3 and not FORCE_SUB_CHANNEL_4 and FORCE_SUB_CHANNEL_REQUEST_1 and FORCE_SUB_CHANNEL_REQUEST_2 and FORCE_SUB_CHANNEL_REQUEST_3 and not FORCE_SUB_CHANNEL_REQUEST_4:
        buttons = [
            [
                InlineKeyboardButton(text = "• عضویت اول", url = client.reinvitelink1)
            ],
        ...
        try:
            ...
            pass
        return buttons
    if not FORCE_SUB_CHANNEL_1 and not FORCE_SUB_CHANNEL_2 and not FORCE_SUB_CHANNEL_3 and not FORCE_SUB_CHANNEL_4 and FORCE_SUB_CHANNEL_REQUEST_1 and FORCE_SUB_CHANNEL_REQUEST_2 and FORCE_SUB_CHANNEL_REQUEST_3 and FORCE_SUB_CHANNEL_REQUEST_4:
        buttons = [
            [
                InlineKeyboardButton(text = "• عضویت اول", url = client.reinvitelink1)
            ],
            ...
            [
                InlineKeyboardButton(text = "• عضویت چهارم", url = client.reinvitelink4)
            ]
        ]
        try:
            buttons.append(
            ...
            pass
        return buttons
    if FORCE_SUB_CHANNEL_1 and FORCE_SUB_CHANNEL_2 and not FORCE_SUB_CHANNEL_3 and not FORCE_SUB_CHANNEL_4 and FORCE_SUB_CHANNEL_REQUEST_1 and FORCE_SUB_CHANNEL_REQUEST_2 and not FORCE_SUB_CHANNEL_REQUEST_3 and not FORCE_SUB_CHANNEL_REQUEST_4:
        buttons = [
            [
                InlineKeyboardButton(text = "• عضویت اول", url = client.invitelink1)
            ],
            ...
            [
                InlineKeyboardButton(text = "• عضویت سوم", url = client.reinvitelink1)
            ],
            [
                InlineKeyboardButton(text = "• عضویت چهارم", url = client.reinvitelink2)
            ]
        ]
        try:
            buttons.append(
            ...
            pass
        return buttons
    if FORCE_SUB_CHANNEL_1 and not FORCE_SUB_CHANNEL_2 and not FORCE_SUB_CHANNEL_3 and not FORCE_SUB_CHANNEL_4 and FORCE_SUB_CHANNEL_REQUEST_1 and not FORCE_SUB_CHANNEL_REQUEST_2 and not FORCE_SUB_CHANNEL_REQUEST_3 and not FORCE_SUB_CHANNEL_REQUEST_4:
        buttons = [
            [
                InlineKeyboardButton(text = "• عضویت اول", url = client.invitelink1)
            ],
            [
                InlineKeyboardButton(text = "• عضویت دوم", url = client.reinvitelink1)
            ]
        ]
        try:
            buttons.append(
